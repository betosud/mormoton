        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{--<img style="max-width:55px; margin-top: -2px;" src="{!! asset('imagenes/logo.png') !!}" border="0">--}}
                    Mormoton
                </a>
            </div>
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ route('questions')}}"><i class="glyphicon glyphicon-th-list"></i>Preguntas</a></li>
                            </ul>
                        </li>
                        @endrole
                        <li class="dropdown">
